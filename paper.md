...
**Source Corpus.** 82 publications: 56 academic papers, 15 standards/RFCs, 11 grey literature items (vendor whitepapers, malware analysis reports).
...
|------|------------|-------|-----------------------|
| 1 | Structurally resilient *against Operator Synthesis* | Type IV (PATs), Type V (DBSC/Passkeys) | Cryptographic binding independent of input modality; VLM cannot forge attestation keys. Device compromise and SDK-proxying are orthogonal attack chains (Section 4.3). |
...
(See `notes/bibliography.md` for the complete 82-reference bibliography, common to all versions of this paper.)
