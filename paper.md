...
- **L3 (Execution Traps)** — Console-bound traps, anti-debugger hooks, prototype integrity checks [24]. Under OS: no DevTools opened, no runtime instrumented — traps are never triggered. Near-zero cost at the VM level.
...
| L3 | Mixed (trap identification + overhead) | Near-zero | Traps never triggered in stock browser |
