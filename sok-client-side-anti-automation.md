...
**VLM Resilience Tier Ranking.**

| Tier | Definition | Types | Degradation Mechanism |
|------|------------|-------|-----------------------|
| 1 | Structurally resilient | Type IV (PATs), Type V (DBSC/Passkeys) | Cryptographic binding independent of input modality; device compromise required |
| 2 | Degraded — cost-shifted | Type I (VM Attestation), Type III (Behavioral Biometrics) | Detection premise bypassed at cognitive level; residual costs from container-evasion (Type I) or kinematic orchestration (Type III) remain |
...
(See `bibliography.md` for the complete 78-reference bibliography)
